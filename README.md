...
In order to get this project running correctly you will need to download the assets folder which contains a CSS folder including a CSS style file, an images folder which contains the image assets included in the webpage and the index HTML file which includes the page structure

## Usage

The use of this project is to adjust an HTML file that is setup with proper semantic tags and efficient CSS styling

## Credits

This project was created by Ben Wright and has updated tags and styling by Kyle Goldfarb

## License

This project is open to anyone looking for a reference in proper semantic tags and efficient CSS styling
